                ...
                <div className="bg-gradient-to-br from-rose-50 to-pink-50 rounded-2xl p-6 border border-rose-200">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center">
                      ...
                      <span className="text-gray-700">{service.services.length} different services available</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-3 h-3 bg-rose-400 rounded-full mr-3"></div>
                      <span className="text-gray-700">Professional and experienced staff</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-3 h-3 bg-rose-400 rounded-full mr-3"></div>
                      <span className="text-gray-700">High-quality products and equipment</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-3 h-3 bg-rose-400 rounded-full mr-3"></div>
                      <span className="text-gray-700">Comfortable and clean environment</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {service.services.map((serviceItem, index) => {
                  ...
                  return (
                    <div 
                      key={index} 
                      className="flex justify-between items-center p-4 bg-gray-50 rounded-xl hover:bg-rose-50 transition-colors duration-200 border border-gray-100"
                    >
