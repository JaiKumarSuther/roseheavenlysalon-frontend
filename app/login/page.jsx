      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4">
        <div className="w-full max-w-md animate-fade-in">
          ...
          {showVerificationMessage && (
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mb-6 animate-fade-in-up">
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-yellow-700">
                    <p>
                      Your email address <strong>{unverifiedEmail}</strong> hasn't been verified yet. 
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-8 border border-white/20 shadow-soft animate-fade-in-up">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link href="/forgotpass" className="text-sm text-gray-500 hover:text-gray-600 transition-colors">
                  Forgot password?
                </Link>
              </div>
