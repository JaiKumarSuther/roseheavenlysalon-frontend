        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-3">
              ...
              <span className="font-serif text-2xl font-bold bg-gradient-to-r from-gray-600 to-gray-700 bg-clip-text text-transparent">
                Rose Heavenly
              </span>
            </div>
            ...
            <div className="flex space-x-4">
              <a 
                ...
                className="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-soft hover:shadow-medium transition-all duration-300 hover:bg-gray-50 hover:scale-110"
                target="_blank"
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={link.href}>
                  <Link 
                    href={link.href} 
                    className="block text-gray-600 hover:text-gray-500 transition-colors duration-300"
                  >
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3 text-gray-600 hover:text-gray-500 transition-colors duration-300">
