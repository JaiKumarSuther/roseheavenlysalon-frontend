          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              <a 
                ...
                className="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-soft hover:shadow-medium transition-all duration-300 hover:bg-rose-50 hover:scale-110"
                target="_blank"
