    ...
    <footer className="bg-gradient-to-br from-gray-50 to-rose-50 border-t border-rose-100">
      <div className="container-custom section-padding">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              <a 
                ...
                className="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-soft hover:shadow-medium transition-all duration-300 transform hover:scale-110 hover:bg-rose-50"
                target="_blank"
            ...
            <div className="space-y-3">
              {[
                ...
                <Link 
                  key={link.href}
                  href={link.href} 
                  className="block text-gray-600 hover:text-rose-600 transition-colors duration-300 transform hover:translate-x-1"
                >
                  {link.label}
                </Link>
              ))}
          ...
          {/* Extra Links */}
          <div className="space-y-6">
            <h3 className="text-lg font-semibold text-gray-800">Extra Links</h3>
            <div className="space-y-3">
              {[
